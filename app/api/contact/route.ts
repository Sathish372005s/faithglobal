...
export async function POST(req: Request) {
  try {
    ...
    const htmlContent = `
      ...
      <html>
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>faith global logistics</h1>
              <p>Going An Extra Mile For You</p>
            </div>
            ...
            <div class="content">
              <table class="grid-table">
                ...
                <tr>
                  ...
                  <td class="value"><span style="background-color: rgba(201, 162, 74, 0.15); border: 1px solid #C9A24A; padding: 3px 8px; border-radius: 3px; color: #DFBA6B; font-weight: bold; font-size: 12px;">${serviceType}</span></td>
                </tr>
              </table>
    ...
    if (!emailUser || !emailPass || !receiverEmail) {
      ...
      console.log(`Subject: New Security Service Inquiry - ${serviceType}`);
      console.log(`Content:\nName: ${name}\nEmail: ${email}\nPhone: ${phone}\nService: ${serviceType}\nMessage: ${message}`);
      console.log("======================");
    ...
    const mailOptions = {
      ...
      to: receiverEmail,
      subject: `New Security Service Inquiry - ${serviceType}`,
      html: htmlContent,
      replyTo: email
    };
